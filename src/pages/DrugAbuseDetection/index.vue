<template>
  <watermarkContent>
    <div class="drugAbuseDetectionIndex">
      <div class="drugAbuseDetectionIndexBox">
        <FilterSearchBox>
          <FilterSearchItem>
        ...
        <FilterSearchContent>
          <div id="drugAbuseDetectionTable" class="drugAbuseDetectionTable">
                    ...
                    >
                      <div style="text-align: right; margin: 0">
                        ...
                        <span
                          title="导出尿液提取笔录"
                          class="operationBtn2"
                          @click="handleUrineExport(scope.row)"
                          >导出尿液提取笔录
                        </span>
                      </div>
                      <span
...
.drugAbuseDetectionIndex {
  height: 100%;
  width: 100%;
  background: #fff;
  box-sizing: border-box;
  border: solid 8px #f2f2f2;
  .drugAbuseDetectionIndexBox {
    width: 100%;
    height: ~'calc(100% - 56px)';
    .drugAbuseDetectionTable {
      width: 100%;
      height: 100%;
      .table-container {
        height: 100%;
