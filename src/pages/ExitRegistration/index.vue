<template>
  <watermarkContent>
    <div class="exitRegistrationIndex">
      <div class="exitRegistrationIndexBox">
        <FilterSearchBox>
          <FilterSearchItem>
        ...
        <FilterSearchContent>
          <div id="exitRegistrationTable" class="exitRegistrationTable">
