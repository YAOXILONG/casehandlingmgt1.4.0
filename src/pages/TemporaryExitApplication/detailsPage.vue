<template>
  <watermarkContent>
    <div class="temApplication-detail-box add-edit-from-box full">
          ...
          <div class="applicationDetailSituationTableBox">
            <div class="tableContent clearfix">
              <ul class="applicationDetailSituationTable clearfix">
                ...
                <el-col :span="12">
                  <li class="tableItem">
                    <div class="tableItemLabel">出区原由</div>
                    <div
                      class="tableItemCon"
...
export default {
  name: "ExitApplicationDetails",
  data() {
    return {
      active5: 2,
      pathDescArr: ["临时出区申请", `${this.$route.query.id ? "详情" : ""}`],
      inqDictList: [],
      ...
      try {
        ...
        if (res.data.code === "0") {
          ...
          if (data) {
            ...
            // this.currentPerson.applyStatus == 1
            //   ? (this.span = 12)
            //   : (this.span = 24);
          } else {
            this.currentPerson = {};
